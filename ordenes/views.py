...
def payments(request):
    ...
    cart_items = CarroItem.objects.filter(user=request.user)
    ...
    for item in cart_items:
        ...
        cart_item = CarroItem.objects.get(id=item.id)
...
def place_order(request, total=0, quantity=0):
    ...
    cart_items = CarroItem.objects.filter(usuario=current_user)
